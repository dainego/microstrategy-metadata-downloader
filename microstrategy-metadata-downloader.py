...
def api_call(method, url, cookies, headers=None, params=None, json_body=None, logger=None,timeout=30):
    try:
...
def main():
    ...
    if option == "1":
        ...
        root_attributes = root_atributes_big_data
